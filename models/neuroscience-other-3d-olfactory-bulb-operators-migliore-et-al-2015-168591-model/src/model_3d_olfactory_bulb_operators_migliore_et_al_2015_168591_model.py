...
"""Auto-generated BioModule wrapper for 3D olfactory bulb: operators (Migliore et al, 2015).

Source: modeldb:168591
Original: https://modeldb.science/168591
Standard: other
...
class Other3dOlfactoryBulbOperatorsMiglioreEtAl2015(biosim.BioModule):
    """Placeholder BioModule wrapper for: 3D olfactory bulb: operators (Migliore et al, 2015).
    ...
    def __init__(self, model_path: str = "data/168591.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
