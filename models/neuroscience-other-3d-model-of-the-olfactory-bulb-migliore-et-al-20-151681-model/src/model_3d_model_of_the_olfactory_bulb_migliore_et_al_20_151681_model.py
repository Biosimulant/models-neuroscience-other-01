...
"""Auto-generated BioModule wrapper for 3D model of the olfactory bulb (Migliore et al. 2014).

Source: modeldb:151681
Original: https://modeldb.science/151681
Standard: other
...
class Other3dModelOfTheOlfactoryBulbMiglioreEtAl2014(biosim.BioModule):
    """Placeholder BioModule wrapper for: 3D model of the olfactory bulb (Migliore et al. 2014).
    ...
    def __init__(self, model_path: str = "data/151681.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
