...
"""Auto-generated BioModule wrapper for 3D-printer visualization of NEURON models (McDougal and Shepherd, 2015).

Source: modeldb:182785
Original: https://modeldb.science/182785
Standard: other
...
class Other3dPrinterVisualizationOfNeuronModelsMcdougalAnd(biosim.BioModule):
    """Placeholder BioModule wrapper for: 3D-printer visualization of NEURON models (McDougal and Shepherd, 2015).
    ...
    def __init__(self, model_path: str = "data/182785.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
